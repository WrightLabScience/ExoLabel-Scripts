...
available in RealDataBenchmark.tar.gz from Zenodo.
...
in RealDataBenchmark.tar.gz from Zenodo. The following scripts are used:
...
found in SyntheticBenchmark.tar.gz from Zenodo. The source data for this figure
